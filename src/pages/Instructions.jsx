               ...
               <VStack align="stretch" spacing={6}>
                  <Box>
                     ...
                     <Text color="whiteAlpha.900" fontSize="lg">
                        The aim of <b>Klondike Solitaire</b> is to organize all cards into four "Foundation" piles at the top of the screen. Each pile must be built from <b>Ace to King</b> by matching the suit (Hearts, Diamonds, Clubs, or Spades).
                     </Text>
                  </Box>
                  ...
                  <Box>
                     ...
                     <UnorderedList spacing={3} color="whiteAlpha.900" ml={6}>
                        <ListItem>
                           ...
                           You can place a card on another card only if it is the <b>opposite color</b> (Red on Black, or Black on Red).
                        </ListItem>
                        <ListItem>
                           <Text fontWeight="bold" color="green.500">2. Descending Order:</Text>
                           The card you move must be <b>one rank lower</b> than the one you place it on (e.g., a 9 goes on a 10).
                        </ListItem>
                        <ListItem>
                        ...
                        <ListItem>
                           ...
                           Only a <b>King</b> (or a stack starting with a King) can be placed in an empty column on the Tableau.
                        </ListItem>
                        <ListItem>
